...
<?php echo form_open(base_url().'record/new_record/' . $this->uri->segment(3),$attributes);?>
   <?php
...
echo '<table width=800 border=0 align=center cellspacing=1 bgcolor= #AFC7C7>';
	...
	echo'<tr>';
		...
		echo'</td>';
		echo'<td>';
			 echo form_dropdown('utility',$dropdown_callutility, isset($_POST['utility']) ? $_POST['utility']:'');
		echo'</td>';
		echo'<td>';
		echo'</td>';
		echo'<td>';
	...
	echo'<tr>';
		...
		echo'</td>';
		echo'<td>';
			echo form_dropdown('call_origin',$dropdown_callorigin, isset($_POST['call_origin']) ? $_POST['call_origin']:'');
		echo'</td>';
		echo'<td></td>';
		echo'<td>';
			echo"Web&nbsp;Enrollment?";
	...
	echo'<tr>';
		...
		echo'</td>';
		echo'<td>';
			echo form_dropdown('promo_offered',$dropdown_callpromo, isset($_POST['promo_offered']) ? $_POST['promo_offered']:'');
		echo'</td>';
		echo'<td></td>';
		echo'<td>';
		...
		echo'</td>';
		echo'<td>';
			echo form_dropdown('web_dispo',$dropdown_callwebdispo, isset($_POST['web_dispo']) ? $_POST['web_dispo']:'');
		echo'</td>';
	echo'</tr>';
	echo'<tr>';
		echo'<td>';
		...
		echo'</td>';
		echo'<td>';
			echo form_dropdown('source',$dropdown_callsource, isset($_POST['source']) ? $_POST['source']:''); 
		echo'</td>';
	echo'</tr>';
	echo'<tr>';
		echo'<td>';
...
echo'<table width=800 border=0 align=center cellspacing=1 bgcolor=	#fbf7bb>';
	...
	echo '</tr>';
echo'</table>';
echo '<table width=800  border=0 align=center cellspacing=1 bgcolor= #000000>';
	echo '<tr>';
		echo '<td>';
