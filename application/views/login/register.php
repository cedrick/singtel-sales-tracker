...
<body>
	<div class="content">
		<div class="header">SingTel Sales Tracker <span>{Register}</span></div>
		<div class="body">
			<div class="section">
				...
				<table>
					...
					<tr>
						<td><input type="submit" name="login" value="Register" /> &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>login">Login</a><?php echo validation_errors(); ?><p><?php echo isset($error) ?  $error : ''; ?></p></td>
					</tr>
