		...
		<div class="body">
			...
			<div class="section">
				...
				<table>
					<tr>
						<td></td>
						<td style="padding: 0; margin: 0;"><a href="<?php echo base_url(); ?>quality/export_excel/<?php echo $this->uri->segment(3); ?>" ><img src="<?php echo base_url();?>includes/images/Excel-Logo.jpg"/> &nbsp;<span style="position: absolute; margin-top: 8px;">Excel File</span></a></td>
					</tr>
				</table>
			</div>
			<div class="section">
